...
function SpotifyActivityToggleButton() {
    ...
    return (
        <Button
            tooltipText={spotifyConnection ? "Stop sharing your Spotify activity" : "Share your Spotify activity"}
...
export default definePlugin({
    ...
    description: "Adds a button that allows you to toggle the visibility of your Spotify activity",
