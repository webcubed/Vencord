...
export default definePlugin({
    ...
    description: "Shows how much longer a user's timeout will last and why they are timed out, either in the timeout icon tooltip or next to it. This plugin is a replacement for ShowTimeoutDuration!",
