...
function messageCreateHandler(payload: MessageCreatePayload) {
    ...
    if (!settings.store.cacheMessagesFromServers && payload.guildId != null) {
        ...
        if (!isWhitelisted) {
            return; // don't cache messages from servers when cacheMessagesFromServers is disabled and not whitelisted
        }
    }
...
export default definePlugin({
    ...
    authors: [Devs.Aria],
    description: "Expansion for MessageLogger",
    ...
    patches: [
        ...
        // don't fetch messages for channels in modal
        {
