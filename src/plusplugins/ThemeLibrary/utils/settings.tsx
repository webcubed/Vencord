        ...
        component: () => {
            ...
            return (
                <Forms.FormSection>
                    ...
                    <Forms.FormText style={{ marginTop: 0, marginBottom: 8 }}> All theme authors are given credit in the theme info. No CSS has been modified. Ff you wish your theme to be removed anyway, open an issue by clicking below.</Forms.FormText>
                    <div className={cl("button-grid")}>
