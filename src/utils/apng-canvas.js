        ...
        (function (G, q) {
          ...
          (t = this),
            (e = function () {
              ...
              function C(t, e, n) {
                e.constructor === t.constructor && n === w && e.constructor.resolve === y
                  ? (function (e, t) {
                      t._state === P
                        ? O(e, t._result)
                        : t._state === x
                  ...
                  n(e)
                    ? ((this.length = e.length),
                      ...
                      0 === this.length
                        ...
                        : ((this.length = this.length || 0), this._enumerate(e), 0 === this._remaining && O(this.promise, this._result)))
              ...
              if (0 === r.numPlays || o / r.frames.length <= r.numPlays) {
                for (
                  0 === e &&
                    ...
                    (a = n).iData = null,
                    2 === a.disposeOp && (a.iData = c[0].getImageData(n.left, n.top, n.width, n.height)),
                    0 === n.blendOp &&
                      c.forEach(function (t) {
              ...
              return (
                ...
                i.parseURL(s.src).then(
                  function (t) {
                    ...
                    (e.width = t.width),
                      (e.height = t.height),
                      Array.prototype.slice.call(s.attributes).forEach(function (t) {
                ...
                (w(A, function (t, e, n, r) {
                  switch (t) {
                    ...
                    case "fcTL":
                      ...
                      0 === o && (o = 100),
                        (c.delay = (1e3 * i) / o),
                        c.delay <= 10 && (c.delay = 100),
                        (f.playTime += c.delay),
                        (c.disposeOp = b(e, n + 8 + 24)),
